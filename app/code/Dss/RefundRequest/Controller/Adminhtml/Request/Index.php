...
{
    protected const ADMIN_REQUEST_INDEX = "Dss_RefundRequest::refundrequest_access_controller_request_index";
    ...
    {
        return $this->_authorization->isAllowed(self::ADMIN_REQUEST_INDEX);
    }
}
